...
Student::Student(string _fname, string _lname, float _cgpa, int _score, int _id) : first_name(_fname), last_name(_lname), CGPA(_cgpa), research_score(_score), app_id(_id) {}
